...
<table border=1 style="width:100% ;height:100%">
    ...
    <tr>    
        <td align=center rowspan=1 width=120; style="vertical-align:middle;background-color: #0E7486;color:white;">功能性方块</td>
        <td align=left colspan=2><img src=resources/icon/wall_calendar_sign-32px.png> <a href="common/functional_blocks/wall_calendar_sign.md">挂历</a> <img src=resources/image/driftwood.gif> <a href="common/functional_blocks/driftwood.md">浮木/浮竹</a> <img src=resources/icon/electrostatic_discharge_rod-32px.png> <a href="common/functional_blocks/electrostatic_discharge_rod.md">静电释放器</a> <img src=resources/icon/packed_barrel-32px.png> <a href="common/functional_blocks/packed_barrel.md">打包过的木桶</a></td>
    </tr> 
</table>
...
<table border=1 style="width:100% ;height:100%">
    ...
    <tr>       
     ...
     <td align=left><img src=resources/icon/debug_copper_stick-32px.png> <a href="common/utilities/debug_copper_stick.md">铜调试棒</a> </td>
	</tr> 
</table>
...
<table border=1 style="width:100% ;height:100%;">
    ...
    <tr>    
        <td align=center rowspan=3 width=120; style="vertical-align:middle;background-color: #0E7486;color:white;">材料</td>
